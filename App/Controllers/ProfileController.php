...
class ProfileController extends AControllerBase
{
    ...
    public function profileData()
    {
        ...
        return $this->html(['user_id' => $user_id, 'user_data' => $user_data, 'folders' => $folders, 'errors' => $errors]);
    }
    ...
    public function editProfile() : Response
    {
        ...
        {
            return $this->html(['user_id' => $user_id, 'username' => $username, 'profile' => $profile, 'errors' => ""]);
        }
        ...
        else if ($new_username != $username)
        {
            ...
            if ($fetched_user && $fetched_user[0]->getUsername() == $new_username && $fetched_user[0]->getId() != $user_id)
            {
        ...
        if ($new_profile_pic_file['name'] != null) {
            ...
            if ($profile->getProfilePic() != null || $profile->getProfilePic() != "") {
